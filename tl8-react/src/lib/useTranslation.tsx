...
export const useTranslation = (key: string, params: Record<string, string | number | boolean> = {}) => {
  ...
  useEffect(() => {
    ...
    const originalTranslation = getValueAtPath(currentTranslations, key.split('.'));
    const overwrittenTranslation = overwrittenTranslations && overwrittenTranslations[key];
    ...
    setResult(interpolate(overwrittenTranslation || originalTranslation, params));
